...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static String now() {
		...
		return sdformat.format(ca.getTime());
...
//		String yyyyMM = new SimpleDateFormat("yyyyMM").format(date);
	 ...
	 * @return
	 */
	public static String getOnAMonth(){
...
/*		System.out.println(formatDate(parseDate("2010/3/6")));
		...
		String date = DateUtils.getDate("yyyy-MM-dd HH:mm:ss", -30, Calendar.DAY_OF_MONTH);
		System.err.println(date);
		Date cc = format.parse(DateUtils.getDate("yyyy-MM-dd HH:mm:ss", -30, Calendar.DAY_OF_MONTH));
		String format1 = format.format(cc);
		System.err.println(format1);
	/*	String	dateBegin = format.format(DateUtils.getDate("yyyy-MM-dd HH:mm:ss", -30, Calendar.DAY_OF_MONTH));
