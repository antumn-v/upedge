...
public class UrlConfig {
    ...
    public final static String NEW_SOURCINBOX_HOST = "http://localhost:8611/";
     ...
     */
    public final  static String SEND_NEW_LOGIN = NEW_SOURCINBOX_HOST+"/ums/user/creatLoginInfo";
    public final  static String SEND_NEW_LOGIN_CODE = "sdfsdghwreerasf.dwrweqe-wefsag!";

    /**
     * 老架构退出登录  发送请求到新架构  新架构删除该用户的登录信息缓存
     */
    public final  static String SEND_NEW_LOGINOUT = NEW_SOURCINBOX_HOST+"/ums/user/delLoginInfo";
     ...
     */
    public final  static String SEND_NEW_ADMIN_LOGINOUT = NEW_SOURCINBOX_HOST+"/ums/user/creatAdminLoginInfo";
     ...
     */
    public final  static String SEND_NEW_APP_NOTICE_LIST = NEW_SOURCINBOX_HOST+"/cms/appNotice/admin/list";
     ...
     */
    public final  static String SEND_NEW_APP_NOTICE_DETAIL = NEW_SOURCINBOX_HOST+"/cms/appNotice/admin/info/";
     ...
     */
    public final  static String SEND_NEW_APP_APPNOTICE_NEW = NEW_SOURCINBOX_HOST+"/cms/appNotice/user/recent";
