...
public class OrderDailyPayCountController {
    ...
    public BaseResponse customerPayOrderStatistics(@RequestBody OrderStatisticsRequest request){
        ...
        List<CustomerOrderStatisticsVo> customerOrderStatisticss = orderDailyPayCountService.customerOrderStatistics(request);
        return new BaseResponse(ResultCode.SUCCESS_CODE,Constant.MESSAGE_SUCCESS,customerOrderStatisticss);
    }
