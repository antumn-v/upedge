 ...
 */
@Data
public class ProductSaiheInventoryUpdateRequest{
    ...
    public ProductSaiheInventory toProductSaiheInventory(String id){
        ProductSaiheInventory productSaiheInventory=new ProductSaiheInventory();
        productSaiheInventory.setVariantSku(variantSku);
